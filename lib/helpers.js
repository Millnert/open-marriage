...
// getJson helper
exports.getJsonContext = function (data, options) {
...
exports.guestsNames = function (options) {
    var attending           = options.hash.attending,
        ...
        attending_badminton = options.hash.attending_badminton,
        name, sep;
...
exports.guests = function (options) {
    return this.guests.reduce(function (output, guest) {
        guest = extend({}, guest, {drinkOptions: options.hash.drinks});
        return output + options.fn(guest);
    }, '');
};

exports.guestDrink = function () {
    var drinkLabel;

    this.drinkOptions.some(function (drink) {
        if (drink.id === this.drink) {
...
exports.isGuestDrink = function (drink) {
    return this.id === drink ? 'checked' : '';
};
